    ...
    <div className="space-y-5 pb-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-0.5">Identify knowledge gaps and eliminate high-risk dosage errors.</p>
        </div>
        <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 bg-red-100 dark:bg-red-950/60 border border-red-200 dark:border-red-900 text-red-700 dark:text-red-300 text-xs font-bold rounded-full">
        ...
        {MISTAKE_CATEGORIES.map((cat) => (
          ...
          >
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 pt-1 font-semibold">
              <span>{cat.mistakesCount} logged in history</span>
